...
using STS2QuickAnimationMode.Patching.Builders;
using STS2QuickAnimationMode.Patching.Models;
using STS2QuickAnimationMode.Patching.Rules;

namespace STS2QuickAnimationMode.Patching.Core
{
    /// <summary>
    ///     Extension methods for HarmonyPatcher to support advanced patch builders
    /// </summary>
