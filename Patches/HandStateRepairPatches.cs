...
namespace STS2QuickAnimationMode.Patches
{
    ...
    public class CardTransformStateRepairGuardPatch : IPatchMethod
    {
        ...
        public static string Description => "Accelerate card transformations while deferring hand state repair";
        public static bool IsCritical => false;
        ...
        {
            __result = SpeedManager.TrackAsync(
                HandStateRepair.GuardDuringHandMutationAsync(__result),
                SafeSpeedReason.CardPileSequence);
        }
    }
}
